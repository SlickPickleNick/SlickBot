...
- Accepted counting messages now receive a configurable accepted-count reaction, and failed count attempts receive a configurable failed-count reaction. Defaults use the green-check and no-entry-sign equivalents.
